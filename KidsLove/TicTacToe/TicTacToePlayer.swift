...
class TicTacToePlayer {
    ...
    func getMove(board: TicTacToeBoard) -> (Int, Int) {
...
class RandomPlayer: TicTacToePlayer {
    override func getMove(board: TicTacToeBoard) -> (Int, Int) {
...
class SmartPlayer: TicTacToePlayer {
    override func getMove(board: TicTacToeBoard) -> (Int, Int) {
...
class SmarterPlayer: TicTacToePlayer {
    
    var player = -1
    var opponent = -1
    var choice = (-1,-1)
    
    func evaluateGameState(board: TicTacToeBoard, depth: Int) -> Int {
    ...
    func minimax(board: TicTacToeBoard, depth: Int) -> Int {
